...
**The exec summary is the first visible line.** Nothing goes above it — no banner, no
status heading. The attested-lane rule rides in an HTML comment at the top instead:
